...
module.bundle.HMR_BUNDLE_ID = "f548374bd312f45a";
"use strict";
...
},{}],"785gi":[function(require,module,exports,__globalThis) {
...
const fetchi = function(from, to, amount) {
    fetch(`https://api.frankfurter.dev/v1/latest?base=${from}&symbols=${to}`).then((resp)=>resp.json()).then((data)=>{
        console.log(data);
